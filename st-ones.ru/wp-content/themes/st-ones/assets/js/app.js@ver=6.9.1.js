(() => {
    ...
    $(document).ready((function() {
        ...
        $(".productcard-section__slider").slick({
            arrows: true,
            slidesToShow: 1,
            slidesToScroll: 1,
            infinity: true,
            fade: true,
            asNavFor: ".productcard-section__slider-preview"
        });
        $(".productcard-section__slider-preview").slick({
            arrows: false,
            dots: false,
            slidesToShow: 5,
            slidesToScroll: 1,
            infinity: true,
            asNavFor: ".productcard-section__slider",
            draggable: false,
            focusOnSelect: true,
            responsive: [ {
                breakpoint: 768,
    ...
    if (window.innerWidth <= 767) {
        ...
        for (var i = 0; i < a.length; i++) a[i].addEventListener("click", click.bind(void 0), false);
        function click(link_class) {
            if (link_class.target.nextElementSibling.classList.contains("sub-menu")) {
                link_class.target.nextElementSibling.classList.remove("sub-menu");
                link_class.target.nextElementSibling.classList.add("section-nav-body-show");
            } else {
                link_class.target.nextElementSibling.classList.add("sub-menu");
                link_class.target.nextElementSibling.classList.remove("section-nav-body-show");
            }
        }
    }
    function addHoverEffect(textSelector, imgSelector) {
    const textElement = document.querySelector(textSelector);
    const imgElements = document.querySelectorAll(imgSelector);

    // Check if the elements exist
    if (!textElement) {
        console.log(`No element found for selector: ${textSelector}`);
        return;
    }

    if (imgElements.length === 0) {
        console.log(`No elements found for selector: ${imgSelector}`);
        return;
    }
    ...
    textElement.addEventListener("mouseover", () => {
        imgElements.forEach(imgElement => {
            ...
            imgElement.style.transition = "all 0.8s ease 0s";
        });
    });
    ...
    addHoverEffect(".text-1", ".statistics__img-top_hov1");
    addHoverEffect(".text-2", ".statistics__img-top_hov2");
    ...
    function enforceMobileBurgerContrast() {
        ...
        style.textContent = [
            ...
            "  .menu-open .menu__body_mob,",
            "  .menu-open .menu__body::before,",
            "  .menu-open .menu__body_mob::before,",
            "  .menu-open .menu__body .menu__list,",
            "  .menu-open .menu__body_mob .menu__list {",
            "    background: #0E1622 !important;",
            "    border-color: rgba(183,154,107,0.35) !important;",
            "  }",
            "  .menu-open .menu__body .menu__list > li > a,",
            "  .menu-open .menu__body_mob .menu__list > li > a,",
            "  .menu-open .menu__body .menu__list > li > span,",
            "  .menu-open .menu__body_mob .menu__list > li > span {",
            "    color: #F6F0E8 !important;",
            "    opacity: 1 !important;",
            "  }",
            "  .menu-open .menu__body .sub-menu li a,",
            "  .menu-open .menu__body_mob .sub-menu li a {",
            "    color: #E7DED1 !important;",
            "    opacity: 1 !important;",
            "  }",
            "  .menu-open .menu__body .menu__list > li,",
            "  .menu-open .menu__body_mob .menu__list > li,",
            "  .menu-open .menu__body .sub-menu li,",
            "  .menu-open .menu__body_mob .sub-menu li {",
            "    border-color: rgba(246,240,232,0.22) !important;",
            "  }",
            "}"
        ].join("");
